    ...
    public partial class InitialMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryEntryDetails_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryExitDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryExitDetails_InventoryExits_InventoryExitId",
                        column: x => x.InventoryExitId,
                        principalTable: "InventoryExits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryExitDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryExitDetails_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryEntryDetails_UserId",
                table: "InventoryEntryDetails",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryExitDetails_InventoryExitId",
                table: "InventoryExitDetails",
                column: "InventoryExitId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryExitDetails_ProductId",
                table: "InventoryExitDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryExitDetails_UserId",
                table: "InventoryExitDetails",
                column: "UserId");
